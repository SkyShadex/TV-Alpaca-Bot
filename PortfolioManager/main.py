...
pm = {'DEV' : PortfolioManager(client=api.client['DEV']),
...
def manageSchedules(TradingHours,OrderReset,equities,options,portfolio,onInit):
    ...
    if portfolio[0]:
        ...
        scheduler.add_job(id='parse_signals', func=pm['DEV'].parseSignals, trigger='cron', day_of_week='mon-fri', minute='*/10', start_date='2024-03-25 13:15:00')
        scheduler.add_job(id='parse_signals_live', func=pm['LIVE'].parseSignals, trigger='cron', day_of_week='mon-fri', minute='*/10', start_date='2024-03-25 13:20:00')
